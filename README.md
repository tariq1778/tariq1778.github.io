...
1. (Optional) Use the Jupyter notebooks or python scripts into the `markdown_generator` folder to generate markdown files for publications and talks from a TSV file.
